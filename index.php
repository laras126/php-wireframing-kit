        ...
        <div class="main wrap clearfix animated bounceInUp">
            ...
            <div class="ninecol first">
                ...
                <article class="sixcol first">
                    ...
                    <section>
                        <p class="h1">class .h1</p>
                        <p class="h2">class .h2</p>
                        <p class="h3">class .h3</p>
                        <p class="h4">class .h4</p>
                        <p class="h5">class .h5</p>
                    </section>
                    <footer>
                 ...
                 <article class="sixcol last">
                    ...
                    <section>
                        <h3>Some Style Deets (h3)</h3>
                        <p>&darr; an <strong>unordeered</strong> list &darr;</p>
                        <ul>
                            <li>Strong: <strong>Culpa vero</strong>.</li>
                            <li>Emphasis: <em>Salvia mollit brunch</em>.</li>
                            <li>Ampersand: <span class="amp">&amp;</span></li>
                        </ul>
                        <p>Whatever bicycle rights blog ethnic, tattooed pinterest biodiesel delectus assumenda sunt vinyl. Mumblecore wes anderson sapiente, cardigan viral polaroid echo park tattooed vero. Sapiente sunt wes anderson, tofu umami art party nihil anim brunch eiusmod aute. Pour-over velit leggings bespoke.</p>
                        <p>&darr; an <strong>ordeered</strong> list &darr;</p>
                        <ol>
                            <li>Strong: <strong>Culpa vero</strong>.</li>
                            <li>Emphasis: <em>Salvia mollit brunch</em>.</li>
                            <li>Ampersand: <span class="amp">&amp;</span></li>
